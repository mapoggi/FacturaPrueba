...
public class Factura {
    ...
    public static void main(String[] args) {
        ...
        unPais = new Pais();
        unPais.setAlias("ARG");
        unPais.setCod_area("+054");
        unPais.setNombre("Argentina");
        
        Provincia unaProv = new Provincia();
        unaProv.setPais(unPais);
        unaProv.setNombre("Buenos Aires");
        unaProv.setAlias("Bs As");
        
        Provincia unaProvDos = new Provincia();
        unaProv.setPais(unPais);
        unaProv.setNombre("Entre Rios");
        unaProv.setAlias("Bs");
        
        Partido unPar = new Partido();
        unPar.setProvincia(unaProv);
        unPar.setNombre("San Martin");
        
        Localidad unLoc = new Localidad();
        unLoc.setPartido(unPar);
        unLoc.setNombre("Ballester");
